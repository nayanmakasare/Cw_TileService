...
// RegisterTileServiceHandlerServer registers the http handlers for service Cw_TileService to "mux".
...
// RegisterTileServiceHandler registers the http handlers for service Cw_TileService to "mux".
...
// RegisterTileServiceHandlerClient registers the http handlers for service Cw_TileService
